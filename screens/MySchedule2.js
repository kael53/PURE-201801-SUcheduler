...
const styles = StyleSheet.create({
  container: { flex: 1, padding: 20, paddingTop: 300, backgroundColor: '#fff' }, //padding --> yanlardaki bosluk, padding top ==> ustteki bosluk
  head: {  height: 34,  backgroundColor: '#f1f8ff'  },
